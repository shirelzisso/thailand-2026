...
export default function App() {
  ...
  const screen = {
    ...
    facts: <Facts child={store.state.activeChild} onStar={() => store.addStar(store.state.activeChild)} />,
    food: <FoodGuide child={store.state.activeChild} onStar={() => store.addStar(store.state.activeChild)} />,
