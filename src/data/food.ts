...
export const foodItems: FoodItem[] = [
  ...
  { id: 'padthai-shrimp', categoryHe: 'חייבים לנסות', emoji: '🍜', nameHe: 'פד תאי עם שרימפס', descHe: 'המנה הכי מפורסמת בתאילנד! לבקש בלי רוטב דגים.' },
  ...
  // לשים לב
  { id: 'meat', categoryHe: 'לשים לב', emoji: '⚠️', nameHe: 'מנות עוף ובשר', descHe: 'לרוב לא כשרות — לדלג או לשאול' },
  ...
  { id: 'market-eggs', categoryHe: 'בשווקי הלילה', emoji: '✅', nameHe: 'ביצים ושרימפס על גריל', descHe: 'על גריל פתוח — טרי ובטוח' },
